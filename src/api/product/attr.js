...
// /admin/product/attrInfoList/{category1Id}/{category2Id}/{category3Id}  get 
 export const reqCategoryInfoList = (category1Id, category2Id, category3Id) =>
   request({
...
export const reqAddOrUpdeteAttr = (data) => request({ url: "/admin/product/saveAttrInfo",data,method:'post'});
/* {
    "attrName":""，属性名
