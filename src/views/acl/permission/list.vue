    ...
    >
      ...
      <el-table-column label="操作">
        <template slot-scope="{row}">
          ...
          <el-button :disabled="row.level===4" type="primary" size="mini" icon="el-icon-plus" :title="getAddTitle(row.level)" @click="toAddPermission(row)"></el-button>
          ...
          <el-button :disabled="row.level===1" type="primary" size="mini" icon="el-icon-edit" :title="row.level===4 ? '修改功能' : '修改菜单'" @click="toUpdatePermission(row)"></el-button>
          ...
          <el-button :disabled="row.level===1" type="danger" size="mini" icon="el-icon-delete" title="删除" @click="removePermission(row)"></el-button>
